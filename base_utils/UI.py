...
class Window():
    ...
    def menber_init(self,*input):
        pass
    def clear_data(self,*input):
        pass
    def loading_data(self,*input):
        pass
    def loading_label(self,*input):
        pass
    def draw(self,*input):
        pass
    def draw_call_back(self,*input):
        pass
    def wait_key_process(self,*input):
        pass
    def show(self,*input):
        pass
